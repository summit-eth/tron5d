var CONTRACT_ADDRESS = "TQXiRzgwLha9m6NSGwisvTZeBvQLd6NPyq";
var SOFT_LAUNCH = 1609146000; 
var FULL_LAUNCH = 1609156800; 
...
function load_contract_details(){
  window.hypertron.contract.contractInfo().call()
...
function load_account_details(){
  if(window.hypertron.address != undefined && window.hypertron.address != null){
    window.hypertron.contract.userInfo(window.hypertron.address).call()
      .then(function(response){
...
function load_account_balance(){
  if(window.hypertron.address != undefined && window.hypertron.address != null){
    window.tronWeb.trx.getAccount(window.hypertron.address)
    .then(function(response){
...
function load_account_payments(){
  if(window.hypertron.address != undefined && window.hypertron.address != null){
    window.hypertron.contract.investmentsInfo(window.hypertron.address).call()
    .then(function(response){
...
function deposit(value){
  window.hypertron.contract.deposit(window.referral).send({ callValue: value * 1000000 })
  .then(function(response){
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var load_obj = setInterval(async ()=>{
      if (window.tronWeb && window.tronWeb.defaultAddress.base58) {
        ...
        window.hypertron.address = window.tronWeb.defaultAddress.base58;
        window.hypertron.contract = await window.tronWeb.contract().at(CONTRACT_ADDRESS)
          .catch(function(err){ swal("Oh no :/", err, "error") })
        ...
        document.getElementById("your_address").innerHTML = window.hypertron.address
        document.getElementById("referral_link").value = "https://tron5d.site?r="+window.hypertron.address;
        document.getElementById("your_adr").innerHTML = "<i class='fa fa-lock mr-2 text-success'></i> "+window.hypertron.address.substring(0,12)+"...";
  ...
  window.setInterval(function(){
    if(window.hypertron.address != window.tronWeb.defaultAddress.base58){
      window.hypertron.address = window.tronWeb.defaultAddress.base58;
      document.getElementById("your_address").innerHTML = window.hypertron.address;
      document.getElementById("referral_link").value = "https://tron5d.site?r="+window.hypertron.address;
      document.getElementById("your_adr").innerHTML = "<i class='fa fa-lock mr-2 text-success'></i> "+window.hypertron.address.substring(0,12)+"...";
  ...
  //   e.preventDefault();
  //   window.hypertron.contract.reinvest().send()
